...
swap q[17],q[19]; //cycle: 54
swap q[13],q[16]; //cycle: 55
cx q[16],q[17]; //cycle: 61 //cx q[21],q[22]
//23 original gates
//27 gates in generated circuit
//45 original depth (cycles)
//63 depth of generated circuit
//496 nodes popped from queue for processing.
//38 nodes remain in queue.
